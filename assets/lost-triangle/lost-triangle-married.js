...
// Source of truth: LostTriangleMarried.jsx. See README.md.
...
function EditorialStripC({
  ...
  if (isP) {
    ...
    return /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("line", {
      ...
      opacity: aP
    }, ed.kicker), ed.head.map((l, i) => /*#__PURE__*/React.createElement("text", {
      key: i,
      x: x,
      y: Y + 72 + i * 48,
      fill: Cc.ink,
      ...
      opacity: aP
    }, l)), ed.prose.map((l, i) => /*#__PURE__*/React.createElement("text", {
      key: i,
      x: x,
      y: Y + 72 + ed.head.length * 48 + 22 + i * 30,
      fill: Cc.dim,
      fontFamily: SERIFc,
      fontStyle: "italic",
      fontWeight: 300,
...
function RefPlateC() {
  ...
  }, "GREGG FLEISHMAN"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: MONOc,
      fontSize: 9,
      letterSpacing: '.18em',
  ...
  }, "ORIGINAL CONSTRUCTION")), /*#__PURE__*/React.createElement("div", {
    style: {
      background: '#F5F2EB',
      padding: 16,
...
function SceneIntroC({
  ...
  return /*#__PURE__*/React.createElement("g", {
    ...
    xlinkHref: IMGc('gf-artwork-bronze.png'),
    x: vw * .20,
    y: vh * .04,
    width: vw * .60,
    height: vh * .92,
    ...
    opacity: imgP * .30
  }), !L.cover && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("rect", {
    x: 0,
    y: vh * .38,
    width: vw,
    height: vh * .26,
    fill: "rgba(12,11,10,.74)",
    opacity: ttP
  }), /*#__PURE__*/React.createElement("text", {
    x: vw / 2,
    y: vh * .49,
...
function SceneTriangleC({
  ...
  return /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("circle", {
    ...
    d: `M${bTop[0]},${bTop[1]} L${bR[0]},${bR[1]} L${bBot[0]},${bBot[1]} L${bL[0]},${bL[1]} Z`,
    p: blueP,
    stroke: "#FFFFFF",
    w: 1.4,
    opacity: .6
  }), blueP > .55 && /*#__PURE__*/React.createElement("text", {
    x: bBot[0] + 10,
    y: bBot[1] + 18,
    fill: Cc.blue,
    fontFamily: MONOc,
    fontSize: 11,
    opacity: clc((blueP - .55) / .45, 0, 1),
    style: {
      letterSpacing: '.04em'
    }
  }, "rhombic face"), /*#__PURE__*/React.createElement("circle", {
    cx: c3[0],
    cy: c3[1],
    r: rC,
    fill: "none",
...
function SceneCloseC({
  ...
  return /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("image", {
    xlinkHref: IMGc('gf-emblem-gold.png'),
    x: vw * .28,
    y: vh * .06,
    width: vw * .44,
    height: vh * .88,
...
const SCENES_C = [{
  ...
  ed: {
    kicker: 'ONE · THE SEQUENCE',
    head: ['The Fleishman Sequence'],
  ...
  ed: {
    kicker: 'TWO · THE TRIANGLE',
    head: ['It fits where', 'nothing else does.'],
  ...
  ed: {
    kicker: 'THREE · THE CUBE',
    head: ['Hidden in a unit cube'],
  ...
  ed: {
    kicker: 'FOUR · THE SOLID',
    head: ['Reflected into form.'],
...
function SceneLayerC() {
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    localTime
  }) => /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement(s.c, {
    lt: localTime
  }), s.ed && /*#__PURE__*/React.createElement(EditorialStripC, {
    ed: s.ed,
    lt: localTime
  })))));
}
...
function VideoBodyC({
  ...
  return /*#__PURE__*/React.createElement(LayoutContextC.Provider, {
    ...
    duration: DURATION_C,
    background: Cc.bg,
    persistKey: "animstage-married",
    loop: loop,
    autoplay: true,
    controls: controls
  }, /*#__PURE__*/React.createElement(SceneLayerC, null), controls && /*#__PURE__*/React.createElement(RefPlateC, null), controls && /*#__PURE__*/React.createElement(ProgressDotsC, null)));
}
function LostTriangleMarried(props) {
  return /*#__PURE__*/React.createElement(VideoBodyC, {
    orient: "landscape",
    ...props
  });
}
function LostTriangleMarriedPortrait(props) {
  return /*#__PURE__*/React.createElement(VideoBodyC, {
    orient: "portrait",
    ...props
  });
